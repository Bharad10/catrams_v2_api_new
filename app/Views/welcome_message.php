...
<header>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to CodeIgniter 1<?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>

        <h2>The most Powerfull and small framework with powerful features dedicated to <b style="color: red;"><i>CAT RAMS</i></b></h2>
